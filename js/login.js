...
function ativarBotaoLogin() {
  ...
  if (!botaoAbrirPopup || !estruturaLogin) {
    console.warn(
      "Login desativado neste contexto: botaoAbrirPopup ou estruturaLogin não encontrados.",
    );
    return;
  }
...
export function submit() {
  ...
  if (!bt_login) {
    console.warn(
      "Botão de submit não encontrado, será inicializado quando o HTML for carregado",
    );
    return;
  }
